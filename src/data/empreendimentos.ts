...
export const EMPREENDIMENTOS: EmpreendimentoData[] = [
  {
    ...
    gallery: [
      {
        src: avenueSalaImg,
        alt: "Sala de estar integrada (apartamento 2 dormitórios)",
      },
      {
        src: avenueSala2Img,
        alt: "Sala com varanda (apartamento 3 dormitórios)",
      },
      { src: avenueSalaTvImg, alt: "Sala TV (apartamento 3 dormitórios)" },
      { src: avenueSala3Img, alt: "Sala (apartamento 3 dormitórios)" },
      {
        src: avenueCozinhaImg,
        alt: "Cozinha planejada (apartamento 2 dormitórios)",
      },
      {
        src: avenueCozinha2Img,
        alt: "Cozinha gourmet (apartamento 3 dormitórios)",
      },
    ...
    destaques: [
      ...
      { valor: "SPE a preço de custo", label: "Modelo" },
      { valor: "11 (incluindo subsolo)", label: "Pavimentos" },
    ...
    fichaTecnica: {
      ...
      pavimentos: "11 (incluindo subsolo)",
  ...
  },
  {
    ...
    gallery: [
      ...
      { src: syncRooftopImg, alt: "Rooftop com bar e espelho d'água" },
      { src: syncCoworkingImg, alt: "Coworking" },
      { src: syncAcademiaImg, alt: "Academia" },
      { src: syncAreaVerdeImg, alt: "Área verde com Fire Places" },
      { src: syncElevadorImg, alt: "Elevadores panorâmicos no Átrio Central" },
      { src: syncHallImg, alt: "Hall de entrada" },
      { src: syncSalaJogosImg, alt: "Sala de jogos" },
      { src: syncResidenceImg, alt: "Fachada frontal" },
    ],
    destaques: [
  ...
  },
  {
    ...
    gallery: [
      { src: florianoPubImg, alt: "Pub Augusto" },
      { src: florianoAptoImg, alt: "Apartamento com Garden" },
      { src: florianoQuartoImg, alt: "Dormitório (apartamento com garden)" },
      { src: florianoQuarto2Img, alt: "Estúdio" },
      { src: florianoGourmetImg, alt: "Gourmet Churrasco" },
      { src: florianoCoberturaImg, alt: "Grand Studio" },
      { src: florianoCoworkingImg, alt: "Coworking" },
      { src: florianoAcademiaImg, alt: "Academia Completa" },
      { src: florianoMinimarketImg, alt: "Mini market" },
    ],
    destaques: [
      { valor: "Estúdios, 1 e 2 dormitórios", label: "Tipologias" },
      { valor: "SPE a preço de custo", label: "Modelo" },
      { valor: "14 (incluindo subsolo)", label: "Pavimentos" },
      { valor: "Accione e Zacon", label: "Gestão e Construção" },
    ],
    fichaTecnica: {
      gestora: "Accione Investimentos",
      ...
      pavimentos: "14 (incluindo subsolo)",
      totalUnidades: "172 apartamentos",
    },
    pontosDeInteresse: [
      "Calçadão de Santa Maria - 2 min a pé",
      "UFN - 4 min a pé",
      "Colégio Santa Maria - 1 min a pé",
      "Colégio Sant'Anna - 5 min a pé",
      "Hospital de Caridade - 3 min a pé",
      "Hospital da Unimed - 3 min de carro",
      "Mercados, Farmácias, Petshops, Estacionamentos, Padarias e Pontos de Ônibus nos arredores",
    ],
  },
];
