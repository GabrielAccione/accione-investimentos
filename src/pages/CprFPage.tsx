...
const CARACTERISTICAS = [
  ...
  { label: 'Rentabilidade', value: 'Acima do CDI' },
  { label: 'Isenção de IR', value: 'Sim (pessoa física)' },
  { label: 'Lastro', value: 'Produção agrícola real' },
  { label: 'Registro', value: 'Câmara de liquidação e custódia' },
  { label: 'Amparo legal', value: 'Lei 8.929/94' },
]

const DIFERENCIAIS = [
  'Rentabilidade acima do CDI com isenção de IR para pessoa física',
  'Lastro em produção agrícola real, um dos setores mais sólidos do Brasil',
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'A CPR-F não conta com garantia do FGC, mas é lastreada em produção agrícola real e registrada em câmara de custódia, o que confere segurança jurídica ao investidor.',
  },
  {
    q: 'Como é feita a isenção de IR?',
    a: 'Para pessoas físicas, os rendimentos de CPR-F são isentos de Imposto de Renda, o que aumenta significativamente a rentabilidade líquida comparada a outros produtos.',
  },
  {
        ...
        <div className="section-container relative z-10 py-16 sm:py-20">
          ...
          >
            ...
            <div className="mt-4 flex flex-wrap items-center gap-3">
              <span className="section-tag">Isenção de IR para Pessoa Física</span>
            </div>
      ...
      <section className="bg-[var(--bg-secondary)] py-20 sm:py-24">
        <div className="section-container">
          <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_260px] lg:items-center">
            <div>
              <ScrollReveal>
                <h2 className="text-3xl font-semibold text-[var(--text-primary)]">Por que CPR-F?</h2>
              </ScrollReveal>
        ...
        <div className="section-container text-center">
          <ScrollReveal>
            ...
            <p className="mt-4 text-[var(--text-secondary)]">
              Fale com um especialista da Accione e entenda como essa tese se encaixa no seu portfólio.
            </p>
