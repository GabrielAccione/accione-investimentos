...
export default function IrrSimulatorPage() {
  ...
  const [cashFlows, setCashFlows] = useState<string[]>(['25000', '28000', '32000', '35000', '42000'])
  ...
  useEffect(() => {
    setCashFlows((current) => {
      ...
      if (current.length < parsedHorizon) {
        return [...current, ...Array.from({ length: parsedHorizon - current.length }, () => '0')]
      }
          ...
          <div className="space-y-6">
            ...
            <div className="surface-card p-6 sm:p-8">
              ...
              <div className="mt-8 space-y-5">
                <ComparisonBar label="TIR da operação" value={irr} maxValue={comparisonMax} accent />
                <ComparisonBar
                  label="CDI atual"
